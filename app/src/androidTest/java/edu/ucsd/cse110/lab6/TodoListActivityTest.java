...
public class TodoListActivityTest {
    ...
    public void testDeleteTodo() {
        ...
        scenario.onActivity(activity -> {
            ...
            View deleteButton = firstVH.itemView.findViewById(R.id.textView);
            deleteButton.performClick();

            List<TodoListItem> afterTodoList = todoListItemDao.getAll();
            assertEquals(beforeTodoList.size()-1, afterTodoList.size());
            assertNull(todoListItemDao.get(id));
        });
    }
    ...
    public void testCheckingOffTodo() {
        ...
        scenario.onActivity(activity -> {
            ...
            CheckBox todoCheckbox = firstVH.itemView.findViewById(R.id.checkBox);
